...
module.exports = exports = class Adapter extends EventEmitter {
  constructor(opts = {}) {
    ...
    this._handle = binding.adapterInit(this._path, this, this._ondeviceadded, this._ondeviceremoved)
  }
  ...
  destroy() {
    ...
    for (const device of this._devices.values()) device._adapterHandle = null
    this._devices.clear()
  ...
  _ondeviceadded(path, address) {
    const device = new Device(this._handle, path, address)
